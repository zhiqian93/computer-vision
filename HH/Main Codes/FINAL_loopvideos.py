...
def scheduled_job():
    ...
    class BodyGameRuntime(object):
        ...
        def draw_body(self, joints, jointPoints, depth):
            ...
            self.draw_body_bone(joints, jointPoints, depth, PyKinectV2.JointType_Neck,
            ...
            self.draw_body_bone(joints, jointPoints, depth, PyKinectV2.JointType_SpineMid,
                                PyKinectV2.JointType_SpineBase);
            self.draw_body_bone(joints, jointPoints, depth, PyKinectV2.JointType_SpineShoulder,
                                PyKinectV2.JointType_ShoulderRight);
            self.draw_body_bone(joints, jointPoints, depth, PyKinectV2.JointType_SpineShoulder,
                                PyKinectV2.JointType_ShoulderLeft);
            self.draw_body_bone(joints, jointPoints, depth, PyKinectV2.JointType_SpineBase,
            ...
            self.draw_body_bone(joints, jointPoints, depth, PyKinectV2.JointType_ElbowLeft,
                                PyKinectV2.JointType_WristLeft);
            self.draw_body_bone(joints, jointPoints, depth, PyKinectV2.JointType_WristLeft,
            ...
            self.body_position = (
            jointPoints[PyKinectV2.JointType_SpineMid].x, jointPoints[PyKinectV2.JointType_SpineMid].y)
        ...
        def run(self):
            ...
            videoname = "11 June " + str(self._videosequence) + ".mkv"
            out = cv2.VideoWriter(videoname, fourcc, 20.0,
                                  (self._frame_surface.get_width(), self._frame_surface.get_height()))
            ...
            while not self._done:
                ...
                if self._bodies is not None:
                    for i in range(0, self._kinect.max_body_count):
                        ...
                        # Initialize, track dr
                        if body.tracking_id not in self.tracked_bodies and (
                                joint_points[PyKinectV2.JointType_SpineMid].x > 350):
                        ...
                        if body.tracking_id not in self.tracked_bodies and (
                                0 < joint_points[PyKinectV2.JointType_SpineMid].x < 150):
